...
routes.get("/checkout/appointment", [authJwt.verifyToken, authJwt.verifyPermission], CheckoutController.listCheckoutByIdAppointment);
routes.get("/checkout/:id", [authJwt.verifyToken, authJwt.verifyPermission], CheckoutController.listCheckoutById);
routes.get("/checkout/band/:id_band", [authJwt.verifyToken, authJwt.verifyPermission], CheckoutController.listCheckoutByIdBand);
