...
routes.get(
  "/band",
  [authJwt.verifyToken, authJwt.verifyPermission],
  BandController.listAllBands
);
routes.get(
  "/band/:id",
  [authJwt.verifyToken, authJwt.verifyPermission],
  BandController.listBandById
);
routes.get(
  "/band/owner/:id",
  [authJwt.verifyToken, authJwt.verifyPermission],
  BandController.listBandByUserId
);
routes.patch(
  "/band/:id",
  [authJwt.verifyToken, authJwt.verifyPermission, authJwt.isAdmin],
...
routes.get(
  "/appointment/:id/report",
  [authJwt.verifyToken, authJwt.verifyPermission, authJwt.isAdmin],
  AppointmentController.listMyAppointmentsByTitle
);
routes.get(
  "/appointment/:id/advanced",
  [authJwt.verifyToken, authJwt.verifyPermission],
  AppointmentController.listMyAppointmentsAdvanced
);
routes.get(
  "/appointment/:id",
  [authJwt.verifyToken, authJwt.verifyPermission],
  AppointmentController.listAppointmentById
);
routes.get(
...
routes.get(
  "/appointment/band/:id",
  [authJwt.verifyToken, authJwt.verifyPermission],
  AppointmentController.listAppointmentByBandId
);
routes.patch(
  "/appointment/:id",
  [authJwt.verifyToken, authJwt.verifyPermission, authJwt.isAdmin],
...
routes.get(
  "/label",
  [authJwt.verifyToken, authJwt.verifyPermission],
  LabelController.listAllLabels
);
routes.get(
  "/label/:id",
  [authJwt.verifyToken, authJwt.verifyPermission],
  LabelController.listLabelById
);
routes.patch(
  "/label/:id",
  [authJwt.verifyToken, authJwt.verifyPermission, authJwt.isSuperAdmin],
...
routes.get(
  "/checkout",
  [authJwt.verifyToken, authJwt.verifyPermission],
  CheckoutController.listAllCheckouts
);
routes.get(
  "/checkout/appointment",
  [authJwt.verifyToken, authJwt.verifyPermission, authJwt.isSuperAdmin],
  CheckoutController.listCheckoutByIdAppointment
);
routes.get(
  "/checkout/:id",
  [authJwt.verifyToken, authJwt.verifyPermission],
  CheckoutController.listCheckoutById
);
routes.get(
  "/checkout/band/:id_band",
  [authJwt.verifyToken, authJwt.verifyPermission, authJwt.isSuperAdmin],
  CheckoutController.listCheckoutByIdBand
);
routes.patch(
  "/checkout/:id",
  [authJwt.verifyToken, authJwt.verifyPermission, authJwt.isAdmin],
...
routes.post(
  "/creditor",
  [authJwt.verifyToken, authJwt.verifyPermission, authJwt.isAdmin],
  CreditorController.createCreditor
);
routes.get(
  "/creditor",
  [authJwt.verifyToken],
  CreditorController.listAllCreditors
);
routes.get(
  "/creditor/:id",
  [authJwt.verifyToken],
  CreditorController.listCreditorById
);
routes.patch(
  "/creditor/:id",
...
routes.delete(
  "/creditor/:id",
  [authJwt.verifyToken, authJwt.isSuperAdmin],
  CreditorController.deleteCreditor
);
routes.get("/", (req, res) => {
  if (req.query?.log) {
  ...
  res.json({
    message: "Nice, last update - log mobile issue",
    log: req.query?.log,
  });
});
